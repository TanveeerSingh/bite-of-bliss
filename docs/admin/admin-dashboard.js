(function () {
  ...
  function getFilteredProducts() {
    ...
    return allProducts.filter((product) => {
      ...
      const searchableText = normalizeText(product.name || "");
...
// download the orders in csv format
  function exportOrdersAsCsv() {
    ...
    const csvHeaders = ["Order ID", "Customer Name", "Customer Email", "Items", "Shipping Address", "Total", "Status"];
